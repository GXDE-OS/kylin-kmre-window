...
#ifndef JOYSTICKSINGLEKEY_H
#define JOYSTICKSINGLEKEY_H

#include "joysticksinglebasekey.h"

class JoystickSingleKey : public JoystickSingleBaseKey
{
    Q_OBJECT
public:
    JoystickSingleKey(KmreWindow* window);
