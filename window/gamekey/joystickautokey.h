...
#ifndef JOYSTICKAUTOKEY_H
#define JOYSTICKAUTOKEY_H

#include "joysticksinglebasekey.h"
#include <QWidget>

class JoystickAutoKey : public JoystickSingleBaseKey
{
    Q_OBJECT
public:
    JoystickAutoKey(KmreWindow* window);
