...
#ifndef KMRE_INPUT_DEVICE_H_
#define KMRE_INPUT_DEVICE_H_

#include "mousekey/network/connections.h"
#include "mousekey/network/published_socket_connector.h"
#include "mousekey/network/socket_connection.h"
...
public:
    ...
    void send_events(const QList<EventData> &events);
