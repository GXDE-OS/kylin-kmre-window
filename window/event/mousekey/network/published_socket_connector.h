...
#ifndef KMRE_PUBLISHEDSOCKETCONNECTOR_H
#define KMRE_PUBLISHEDSOCKETCONNECTOR_H

#include <boost/asio/local/stream_protocol.hpp>

#include "event/mousekey/common/do_not_copy_or_move.h"
#include "event/mousekey/runtime.h"
#include "event/mousekey/network/connection_creator.h"
...
private:
    ...
    //kobe:注意，如果路径socket_path= "/run/user/1000/kmre/sockets"不存在，则会报错退出，测试时需要手动创建该目录   /run/user/1000/snap.kmre/kmre/sockets
